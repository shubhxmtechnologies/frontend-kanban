...
const DeleteListModal = ({ isOpen, onClose, onConfirm, listName }: DeleteListModalProps) => {
            ...
            >
                ...
                <div className="p-6">
                    <p className="text-[14px] text-zinc-600 dark:text-zinc-300">
                        Are you sure you want to delete the list <strong>"{listName}"</strong> and all of its cards? This action cannot be undone.
                    </p>
                </div>

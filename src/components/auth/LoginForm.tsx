        ...
        <div className="min-h-screen flex flex-col bg-zinc-50 dark:bg-[#0a0a0c] transition-colors duration-300">
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-4 py-12">
                <div className="w-full max-w-[400px] bg-white dark:bg-[#141416] rounded-xl border border-zinc-200 dark:border-white/[0.08] shadow-xl dark:shadow-none p-7 sm:p-10">
                    ...
                    {/* Eyebrow */}
                    <p className="text-[11px] text-zinc-400 dark:text-zinc-500 uppercase tracking-[0.12em] font-semibold mb-3">Sign in</p>
                    ...
                    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4" aria-live="polite">
                        ...
                        <div className="flex flex-col gap-1.5">
                            <label htmlFor="login-email" className="text-[13px] font-medium text-zinc-700 dark:text-zinc-300">
                                Email
                            </label>
                            <input
                                id="login-email"
                        ...
                        {/* Password */}
                        <div className="flex flex-col gap-1.5">
                            <label htmlFor="login-password" className="text-[13px] font-medium text-zinc-700 dark:text-zinc-300">
                                Password
                            </label>
